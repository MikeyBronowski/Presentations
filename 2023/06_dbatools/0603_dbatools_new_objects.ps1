...
Set-Location "C:\Tools\PowerDBA\06_dbatools"


# new objects
$db1 = New-DbaDatabase -SqlInstance $instances -Name PowerDBA -RecoveryModel Full
$db2 = New-DbaDatabase -SqlInstance $instances -Name PASSSummit2024 -RecoveryModel Full -Owner sa
...
# 1-2 min
$ola = Install-DbaMaintenanceSolution -SqlInstance $instances -Database PASSSummit2024 -InstallJobs
# $ola = Install-DbaMaintenanceSolution -SqlInstance $instances -Database PASSSummit2024 -InstallJobs -ReplaceExisting
