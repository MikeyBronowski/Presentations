...
Configuration SQLInstall
{
     ...
     node $ComputerName
     {
          ...
          <##
          SqlSetup 'InstallNamedInstance2'
          {
               InstanceName        = 'DSC2022'
               Features            = 'SQLENGINE'
               SourcePath          = 'C:\SQL2022'
               SQLSysAdminAccounts = @('Administrators')
               SQLTempDBDir        = 'C:\SQL2022\MSSQL\Data'
               SQLTempDBLogDir     = 'C:\SQL2022\MSSQL\Log'
               SQLBackupDir        = 'C:\SQL2022\MSSQL\Backup'
               UpdateEnabled       = 'False'
               ForceReboot         = $false
               DependsOn           = '[WindowsFeature]NetFramework45'
          }
