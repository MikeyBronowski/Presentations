@description('nicName')
param nicName string = 'bicepdemonic'
...
param publicIpName string = 'bicepdemopublicip'
...
param vmName string = 'bicepdemovm'
...
var virtualNetworkName_var = 'bicepdemovnet'
...
resource dscextension 'Microsoft.Compute/virtualMachines/extensions@2020-12-01' = {
