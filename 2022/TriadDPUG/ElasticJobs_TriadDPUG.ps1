...
############# SETTINGS
    # AZ.SQL
    # Install-Module Az.Sql -MinimumVersion 3.7.0 -Force
    # Import-Module Az.Sql -MinimumVersion 3.7.0
    # https://www.powershellgallery.com/packages/Az.Sql/3.7.0
...
# RESOURCE GROUP
Remove-AzResourceGroup -Name AzureElasticJobs
Remove-AzResourceGroup -Name AzureElasticJobs-backup
