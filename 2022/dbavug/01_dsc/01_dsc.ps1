...
Get-Module SqlServerDsc, PSDesiredStateConfiguration -ListAvailable | update-module
2.0.5
...
Set-Location $env:OneDrive\SQL\Presentation\DSCArmBicep\$dirName\01_dsc
...
Start-DscConfiguration -Path .\dscDemo -Verbose -Force
...
# local zip
Publish-AzVMDscConfiguration -ConfigurationPath ".\dsc_config.ps1" -OutputArchivePath "dscDemo\dsc_config.ps1.zip"
