...
############# SETTINGS
    # AZ.SQL
    # Install-Module Az.Sql -MinimumVersion 3.5.1 -Force
    # Import-Module Az.Sql -MinimumVersion 3.5.1
    # https://www.powershellgallery.com/packages/Az.Sql/3.5.1
...
# RESOURCE GROUP
Remove-AzResourceGroup -Name AzConf2021


CREATE LOGIN job_collection WITH PASSWORD='password!123';
CREATE USER job_collection FROM LOGIN job_collection;
ALTER ROLE db_owner ADD MEMBER [job_collection];
